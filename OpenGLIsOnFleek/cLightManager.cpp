...
//	glGetUniformLocation(shaderID, ssLight.str().c_str());
	...
	this->theLights[8].param2_UL = glGetUniformLocation(shaderID, "theLights[8].param2");
		...
		// vec4 position;
	this->theLights[9].position_UL = glGetUniformLocation(shaderID, "theLights[9].position");
	//        vec4 diffuse;	// Colour of the light (used for diffuse)
	this->theLights[9].diffuse_UL = glGetUniformLocation(shaderID, "theLights[9].diffuse");
	//        vec4 specular;	// rgb = highlight colour, w = power
	this->theLights[9].specular_UL = glGetUniformLocation(shaderID, "theLights[9].specular");
	//        vec4 atten;		// x = constant, y = linear, z = quadratic, w = DistanceCutOff
	this->theLights[9].atten_UL = glGetUniformLocation(shaderID, "theLights[9].atten");
	//        vec4 direction;	// Spot, directional lights
	this->theLights[9].direction_UL = glGetUniformLocation(shaderID, "theLights[9].direction");
	//        vec4 param1;	// x = lightType, y = inner angle, z = outer angle, w = TBD
	this->theLights[9].param1_UL = glGetUniformLocation(shaderID, "theLights[9].param1");
	//        vec4 param2;	// x = 0 for off, 1 for on
	this->theLights[9].param2_UL = glGetUniformLocation(shaderID, "theLights[9].param2");
